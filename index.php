...
<title>::Hazken Digital:: Web Design | Graphic Design | Creative Branding | Digital Printing Service in Lagos </title>
<!-- Plugins CSS -->
...
<meta name="description" content="Let's create an amazing and responsive website, professional graphic design, and digital printing services (high-quality print) for your business brand identity at an affordable price, Get it deliver to your doorstep within Lagos, Nigeria. Creativity as it speaks excellence!">
	...
	<div class="container">
			...
			style="border-bottom: 4px solid #7E2726;">
					<a class="navbar-brand" href="home">
							<img src="src/img/HAZ-KEN DIGITAL.png" alt="web designer in lagos"
...
<li class="dropdown-submenu">
												...
												<ul class="dropdown-menu">
													<li> <a class="dropdown-item" href="large_format_printing">Banner & Sticker</a> </li>
													<li> <a class="dropdown-item" href="banners">Flex Banner</a> </li>
													<li> <a class="dropdown-item" href="rollup_banners">Roll-Up Banner</a> </li>
													<li> <a class="dropdown-item text-danger" href="vehicle_car&bus_branding">Vehicle & Car Branding</a> </li>
											...
											<li> <a class="dropdown-item" href="letterhead_&_envelopes">LetterHead & Envelopes</a> </li>
									...
									<li class="dropdown-submenu">
										<a class="dropdown-item dropdown-toggle" href="#">Gift Items & Souvenirs
												</a>
										<ul class="dropdown-menu">
											...
											<li> <a class="dropdown-item" href="throw_pillows">Customized Pillows</a> </li>
						...
						<li class="nav-item" style="padding-top: 20px"> <a href="https://www.instagram.com/hazken_digital/" target="_blank"
							title="HAZKEN DIGITAL INSTAGRAM" ><i class="fa fa-instagram font-social-media"></i>
											</a></li>
							<li class="nav-item" style="padding-top: 20px"><a href="https://www.facebook.com/hazkendigital/" target="_blank"
							 title="HAZKEN DIGITAL FACEBOOK">
							<i class="fa fa-facebook-square font-social-media"></i></a>
							</li>
							<li class="nav-item" style="padding-top: 20px"><a href="https://twitter.com/HazkenD" target="_blank"
				...
				<div class="row">
					<div class="col-md-8 mb-0 mb-md-5">
						<div class="p-0 text-center text-md-left">
							...
							<p class="text-dark">We can design and develop a website that specifically meets your unique needs, and meets your required standards as well as industry related standards.</p>
						</div>
					</div>
				</div>
				<div class="row">
    ...
    <section class="container-fluid p-2" >
        ...
        <div class="row mx-auto">
            ...
            <div class="col-4">
                ...
                title="Tri-fold brochure printing and design in lagos">
            </div>
            <div class="col-4">
		...
		<div class="footer-content pb-3 text-all-white">
			<div class="container">
					...
					<div class="col-md-3 col-sm-6">
						<div class="widget address text-all-white">
							<ul class="list-unstyled">
								...
								<li class="media mb-3"><i class="mr-3 display-8 ti-headphone-alt"></i> <a class="mr-1" href="tel:+2348176246387">+234 817 624 6387,</a> <a href="tel:+2349029480399">+234 902 948 0399.</a> </li>
                ...
                <li class="nav-item"><a class="nav-link text-danger" href="home">Home</a></li>
					...
					<!-- Footer widget 4 -->
					<div class="col-md-3">
						<div class="widget bg-light p-4 border-radius-3">
							<i class="ti-email newsletter-icon"></i>
							<p class="mb-2" style="color: black;">Subscribe to our newsletter to receive exclusive offers.</p>
							<div class="form-group mb-0">
								<input class="form-control mb-3" type="email" placeholder="Enter email...">
								<button class="btn btn-dark mb-0 text-white"><a href="mailto:hazkendigital@gmail.com" style="text-decoration: none; color:white">Join us</a></button>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="footer-copyright py-3">
			<div class="container">
				<div class="d-md-flex justify-content-between align-items-center py-3 text-center text-md-left">
					<!-- copyright text -->
					<div class="copyright-text text-white">All Rights Reserved ©2020 by <a href="home" style="color: #d4d4d4"> Hazken Digital</a> RC: 3067429</div>
					<!-- copyright links-->
					<div class="copyright-links primary-hover mt-3 mt-md-0">
						<ul class="social-icons">
							...
							<li class="social-icons-item social-linkedin m-0">
								<a class="social-icons-link w-auto pl-3" href="https://www.linkedin.com/in/hazken-digital-868054187" target="_blank"><i class="fa fa-linkedin"></i></a>
							</li>
							<li class="social-icons-item social-envelope m-0">
								<a class="social-icons-link w-auto pl-3" href="mailto:hazkendigital@gmail.com"><i class="fa fa-envelope"></i></a>
							</li>
...
s1.async=true;
s1.src='https://embed.tawk.to/5da23ed9fbec0f2fe3b97247/default';
s1.charset='UTF-8';
