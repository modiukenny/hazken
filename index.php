                            ...
                            <ul class="dropdown-menu" aria-labelledby="blogMenu">
                                ...
                                <li class="dropdown-submenu">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li> <a class="dropdown-item" href="mugs">Custom Mugs</a> </li>
                                        ...
                                        <li class="dropdown-submenu">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li> <a class="dropdown-item" href="customized_gifts">All Branded
                                                        Gifts</a> </li>
                                                <li> <a class="dropdown-item" href="wall_clock">Wall Clock</a> </li>
                                                <li> <a class="dropdown-item" href="customized_mousepad">Mouse Pads</a>
                                                </li>
                                                <li> <a class="dropdown-item" href="printed_keyholders">Key Holders</a>
                                                </li>
                                            </ul>
                                        </li>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="widget address text-all-white">
                            <ul class="list-unstyled">
                                <li class="media mb-3"><i class="mr-3 display-8 ti-map-alt"></i>27, Moore Road, Off
                                    University Road, Yaba, Lagos. </li>
        ...
        <div class="footer-copyright py-3">
            <div class="container">
                <div class="d-md-flex justify-content-between align-items-center py-3 text-center text-md-left">
                    <!-- copyright text -->
                    <div class="copyright-text text-white">Copyright © 2020 by <a href="home" style="color: #d4d4d4">
