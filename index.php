...
<meta property="og:site_name" content="Hazken Digital" />
    <meta property="og:updated_time" content="2026-08-19T11:10:50+00:00" />
<meta property="og:image:width" content="410" />
<meta property="og:image:height" content="214" />
<meta name="keywords" content="Hazken Digital, Print Company in Lagos Nigeria, Web Design in Lagos Nigeria, 
Graphic Design in Lagos Nigeria Hazken Digital, Top Print Company in Lagos Nigeria, Print, Graphic Design" />

    <meta property="article:publisher" content="https://web.facebook.com/hazkendigital" />
	<meta property="article:modified_time" content="2026-08-19T11:10:50+00:00" />
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="dropdown-submenu">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li> <a class="dropdown-item" href="logo_signage">LED Logo Sign Maker</a> </li>
                                            ...
                                            <li class="dropdown-submenu">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-card-left">
                                                        ...
                                                        <li> <a class="dropdown-item" href="dummy-fake-money-print">Event Fake Money</a> </li>
                                                        <li> <a class="dropdown-item" href="foldable-hand-fan">Foldable Hand Fan</a> </li>
                                                        <li> <a class="dropdown-item" href="photo-album">Photo Album</a> </li>
                                                        <li> <a class="dropdown-item" href="stanley-cup">Stanley Cup</a> </li>
                                                    </ul>
                                                </li>
            ...
            <div class="row mb-4">
				...
				<div class="col-md-4 mt-30">
					<div class="feature-box f-style-2 icon-grad h-100">
						...
						<a class="mt-3 btn btn-grad col-4" href="https://wa.me/2349029480399">Order now</a>
					</div>
				</div>
				<div class="col-md-4 mt-30">
					<div class="feature-box f-style-2 icon-grad h-100">
		...
		<div class="container">
			<div class="row class">
				<div class="col-sm-6 d-none d-lg-block">
					<img class="rounded" src="assets/images/portfolio/team.jpg" alt="Hazken Digital Team Lagos Nigeria">
				</div>
				<div class="col-lg-6 ps-3 ps-md-5">
					<h2 class="mb-4 h1">Engaging, purposeful, and creative.</h2>
					<p class="lead">Hazken Team can give you the best quality results for all your business/brand or events needs, 
                        with our professional designers we assured you the best products design, digital print, creative branding 
                        and website design to showcase your products, services, team member, porfolio, online chat, linking to all your social media 
                        handles which promote and enhance your business/brand.
                    </p>
					<!-- feature -->
					<div class="mt-5">
						<div class="feature-box mt-3 f-style-4 h-100 icon-grad">
							<div class="feature-box-icon"><i class="ti-panel"></i></div>
							<h3 class="feature-box-title mb-0">Our Mission</h3>
						...
						<div class="feature-box mt-3 f-style-4 h-100 icon-grad">
							<div class="feature-box-icon"><i class="ti-harddrives"></i></div>
							<h3 class="feature-box-title mb-0">Every issue solved</h3>
							<p class="feature-box-desc">24/7 active for all your issues to be resolved instantly.</p>
						</div>
						<div class="feature-box mt-3 f-style-4 h-100 icon-grad">
							<div class="feature-box-icon"><i class="ti-package"></i></div>
							<h3 class="feature-box-title mb-0">Client Satisfaction</h3>
							<p class="feature-box-desc">We deliver the best quality that will impress our clients, either for business needs or for 
                                souvenir gift items for an upcoming events.
                            </p>
						</div>
					</div>
					<a href="about_us" class="btn btn-grad text-white mb-0 mt-3">View other feature</a>
				</div>
			</div>
		</div>
	</section>
...
<!-- <li class="media mb-3"><i class="mr-3 display-8 ti-headphone-alt"></i> <a class="mr-1" href="tel:+2348176246387">+234 817 624 6387</a> </li> -->                                <li class="media mb-3"><i class="mr-3 display-8 ti-headphone-alt"></i> <a class="mr-1" href="tel:+2349029480399">+234 902 948 0399</a> </li>
            ...
            ></a>
                                ...
                                <ul class="social-icons si-colored-bg light mx-auto d-block mt-3">
                                    <li class="social-icons-item social-whatsapp">
                                        <a class="social-icons-link" href="https://wa.me/2349029480399" target="_blank"><i class="fa fa-whatsapp" ></i
                    ></a>
                                    </li>
                                    <li class="social-icons-item social-facebook">
        ...
        <div class="footer-copyright py-3">
            <div class="container">
                <div class="d-md-flex justify-content-between align-items-center py-3 text-center text-md-left">
                    <!-- copyright text -->
                    <div class="copyright-text text-white">Copyright © 2019 - <span id="demo"></span> <a href="home" style="color: #d4d4d4"> Hazken Digital</a>  All Rights Reserved.</div>
    ...
    <!-- =======================
		footer  -->
    <div> <a href="https://wa.me/2349029480399" class="back-top btn btn-success" target="_blank"><i class="fa fa-whatsapp"></i></a> </div>
