...
<li class="dropdown-submenu">
									...
									<li class="dropdown-submenu">
										...
										<ul class="dropdown-menu">
											...
											<li> <a class="dropdown-item" href="customized_gifts">Customized Gifts</a> </li>
						...
						<li class="nav-item" style="padding-top: 20px"> <a href="https://www.instagram.com/hazken_digital/" target="_blank"
							...
							<li class="nav-item" style="padding-top: 20px; color:  background-color: #40bff5;"><a href="https://twitter.com/HazkenD" target="_blank"
