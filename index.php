                            ...
                            <li class="dropdown-submenu">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown-submenu">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li> <a class="dropdown-item" href="flyers">Flyer & Handbill</a> </li>
                                ...
                                <li class="dropdown-submenu">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li> <a class="dropdown-item" href="Cap_print">Face Caps</a> </li>
                                        <li class="dropdown-submenu">
        ...
        <div class="footer-copyright py-3">
            <div class="container">
                <div class="d-md-flex justify-content-between align-items-center py-3 text-center text-md-left">
                    <!-- copyright text -->
                    <div class="copyright-text text-white">Copyright © 2019 - 2022 by <a href="home" style="color: #d4d4d4">
                            Hazken Digital.</a> All Rights Reserved. BN: 3067429 <br> Happy Birthday to our CEO - <strong>Modiu Kehinde Hazzan</strong></div>
