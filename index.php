        ...
        <div class="footer-copyright py-3">
            <div class="container">
                <div class="d-md-flex justify-content-between align-items-center py-3 text-center text-md-left">
                    <!-- copyright text -->
                    <div class="copyright-text text-white">Seasons Greetings Merry Xmas and Happy New Year in Advance<br>Copyright © 2019 - 2023 by <a href="home" style="color: #d4d4d4">
