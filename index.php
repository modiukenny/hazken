        ...
        <div class="container bg-light">
                ...
                style="background: #DCDDDF; border-radius: 25px">
                  ...
                  <div class="media-body mt-4 align-self-center">
                    ...
                    <p style="font-size: 15px" class="text-dark"><span class="font-weight-bolder" title="Hazken Digital CEO and founder">
		...
		<div class="footer-copyright py-3">
			<div class="container">
				<div class="d-md-flex justify-content-between align-items-center py-3 text-center text-md-left">
					<!-- copyright text -->
					<div class="copyright-text text-white">Copyright © 2020 by <a href="home" style="color: #d4d4d4"> Hazken Digital.</a> All Rights Reserved. RC: 3067429</div>
					<!-- copyright links-->
