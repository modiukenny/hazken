...
<li class="dropdown-submenu">
						...
						<li class="nav-item" style="padding-top: 20px"> <a class="nav-link" href="https://www.instagram.com/hazken_digital/" target="_blank"
							title="HAZKEN DIGITAL INSTAGRAM" ><i class="text-danger fa fa-instagram font-social-media"></i>
											</a></li>
							<li class="nav-item" style="padding-top: 20px;"><a class="nav-link" href="https://www.facebook.com/hazkendigital/" target="_blank"
							 title="HAZKEN DIGITAL FACEBOOK">
							<i class="fa fa-facebook-square font-social-media" style="color: blue"></i></a>
							</li>
							<li class="nav-item" style="padding-top: 20px;"><a class="nav-link" href="https://twitter.com/HazkenD" target="_blank"
