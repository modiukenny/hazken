                        ...
                        <div class="widget address text-all-white">
                            <ul class="list-unstyled">
                                ...
                                <li class="media mb-3"><i class="mr-3 display-8 ti-time"></i>
                                    <p>Mon - Fri: <strong class="text-white">09:00 - 17:00.</strong> <br>Sat: <strong class="text-white">10:00 -
        ...
        <div class="footer-copyright py-3">
            <div class="container">
                <div class="d-md-flex justify-content-between align-items-center py-3 text-center text-md-left">
                    <!-- copyright text -->
                    <div class="copyright-text text-white">Copyright © 2022 by <a href="home" style="color: #d4d4d4">
