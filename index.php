...
<body>
                                ...
                                <li class="dropdown-submenu">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="dropdown-submenu">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li> <a class="dropdown-item" href="single-sided-business-cards">Single-sided Business Card</a> </li>
                                                <li> <a class="dropdown-item" href="double-sided-business-cards">Double-sided Business Card</a> </li>
                                            </ul>
                                        </li>
                                        <li class="dropdown-submenu">
                                            <a class="dropdown-item dropdown-toggle" href="#">Marketing Brochures</a>
                                            <ul class="dropdown-menu">
                                                <li> <a class="dropdown-item" href="bifold&trifold_brochures">Company Profile</a> </li>
                                                <li> <a class="dropdown-item" href="single-sided-business-cards">Bifold Brochures</a> </li>
                                                <li> <a class="dropdown-item" href="double-sided-business-cards">Trifold Brochures</a> </li>
                                            </ul>
                                        </li>
                                        <li> <a class="dropdown-item" href="programme_of_events">Programme of Events</a>
                                        </li>
                                        <li> <a class="dropdown-item" href="posters">Posters</a> </li>

                                        <li class="dropdown-submenu">
                                            <a class="dropdown-item dropdown-toggle" href="#">Large Format Printing</a>
                                            <ul class="dropdown-menu">
                                                <li> <a class="dropdown-item" href="stickers">Stickers</a> </li>
                                                <li> <a class="dropdown-item" href="banners">Flex Banner</a> </li>
                                                <li> <a class="dropdown-item" href="rollup_banners">Roll-Up Banner</a>
                                                </li>
                                                <li> <a class="dropdown-item" href="vehicle_car&bus_branding">Vehicle &
                                                        Car Branding</a> </li>
                                        ...
                                        <li class="dropdown-submenu">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li> <a class="dropdown-item" href="office_stationery">Branding
                                                        Identity</a> </li>
                                                <li> <a class="dropdown-item" href="letterhead_&_envelopes">LetterHead &
                                                        Envelopes</a> </li>
                                                <li> <a class="dropdown-item"
                                                        href="receipt_invoice_waybill_prints">Receipt & Invoice</a>
                                                </li>
                                        ...
                                        <li> <a class="dropdown-item" href="t-shirts">T-shirts Printing & Monogram</a>
                                        </li>
                                        <li> <a class="dropdown-item" href="id_cards">Plastic ID Cards & Lanyard</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="dropdown-submenu">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="dropdown-submenu">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li> <a class="dropdown-item" href="customized_gifts">All Branded Gifts</a> </li>
                                                <li> <a class="dropdown-item" href="wall_clock">Wall Clock</a> </li>
                                        ...
                                        <li class="dropdown-submenu">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li> <a class="dropdown-item" href="nylon_bags">Nylon Bags</a> </li>
                                                <li> <a class="dropdown-item" href="courier_bags">Courier Nylon Bags</a> </li>
                                            </ul>
                                        </li>
                                        <li> <a class="dropdown-item" href="throw_pillows">Throw Pillows</a> </li>
                                       
                                        <li> <a class="dropdown-item" href="frames">Picture Frames</a> </li>
                                        <li> <a class="dropdown-item" href="wedding_cards">Wedding Invitation Cards</a>
                                        </li>
    ...
    <div class="m-4 text-center">
        ...
        <button type="button" class="btn btn-danger m-auto d-block btn-md font-weight-bold" data-toggle="modal"
            data-target="#exampleModal112">
            <span class="bell fa fa-bell"></span> SEND US A MAIL
        </button>
    </div>
    <!-- Modal -->
    <div class="modal fade" id="exampleModal112" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="contact-form p-2" id="contact-form" name="form" method="POST" onsubmit="contactUs()"
                    data-email="hazkendigital@gmail.com"
                    action="https://script.google.com/macros/s/AKfycbz0zrg9yQyvMMqdmBxNrpiuoeBcuHhFCFKM0IoXrw/exec">
                    <!-- Start form message -->
                    <div class="row">
                        <div class="col-12">
                            <div class="alert alert-dark bg-success text-white text-center" role="alert" id="contact1"
                                style="display: none">
                                Your message was sent successfully.
                            </div>
                            <div class="alert alert-dark bg-danger text-white text-center" role="alert" id="contact6"
                                style="display: none">
                                one input is empty.
                            </div>
                            <div class="alert alert-dark bg-danger text-white text-center" role="alert" id="contact2"
                                style="display: none">
                                Name is required.
                            </div>
                            <div class="alert alert-dark bg-danger text-white text-center" role="alert" id="contact3"
                                style="display: none">
                                Email is required.
                            </div>
                            <div class="alert alert-dark bg-danger text-white text-center" role="alert" id="contact4"
                                style="display: none">
                                Subject is required.
                            </div>
                            <div class="alert alert-dark bg-danger text-white text-center" role="alert" id="contact5"
                                style="display: none">
                                Message is required.
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-1">
                            ...
                            <span class="form-group">
                                <input id="con-name" name="name" type="text" class="form-control allContact"
                                    placeholder="Name">
                            </span>
                        </div>
                        <div class="col-md-6 mb-1">
                            <!-- email -->
                            <span class="form-group">
                                <input id="con-email" name="email" type="email" class="form-control allContact"
                                    placeholder="Email">
                            </span>
                        </div>
                        <div class="col-md-12 mb-1">
                            <!-- Subject -->
                            <span class="form-group">
                                <input id="con-subject" name="subject" type="text" class="form-control allContact"
                                    placeholder="Subject">
                            </span>
                        </div>
                        <div class="col-md-12 mb-1">
                            <!-- Message -->
                            <span class="form-group">
                                <textarea id="con-message" name="message" cols="40" rows="6"
                                    class="form-control allContact" placeholder="Message"></textarea>
                            </span>
                        </div>
                        <!-- submit button -->
                        <div class="col-md-12 text-center"><button class="btn btn-dark btn-block btn-contact"
  ...
  Pricing -->
    <section class="pricing-page pricing pricing-center">
        <div class="container">
            ...
            <a class="btn btn-dark mt-4 font-weight-bold text-white" href="#!" data-toggle="modal"
                data-target="#exampleModal15">Order now!</a>
            <!-- Modal -->
            <!-- Modal -->
            <div class="modal fade" id="exampleModal15" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form class="contact-form p-2" id="contact-form" name="form1" method="POST"
                            onsubmit="contactUs1()" data-email="hazkendigital@gmail.com"
                            action="https://script.google.com/macros/s/AKfycbz0zrg9yQyvMMqdmBxNrpiuoeBcuHhFCFKM0IoXrw/exec">
                            <!-- Start form message -->
                            <div class="row">
                                <div class="col-12">
                                    <div class="alert alert-dark bg-success text-white mx-auto" role="alert"
                                        id="contact11" style="display: none">
                                        Your message was sent successfully.
                                    </div>
                                    <div class="alert alert-dark bg-danger text-white mx-auto" role="alert"
                                        id="contact21" style="display: none">
                                        Name is required.
                                    </div>
                                    <div class="alert alert-dark bg-danger text-white mx-auto" role="alert"
                                        id="contact61" style="display: none">
                                        one input is empty.
                                    </div>
                                    <div class="alert alert-dark bg-danger text-white mx-auto" role="alert"
                                        id="contact31" style="display: none">
                                        Email is required.
                                    </div>
                                    <div class="alert alert-dark bg-danger text-white mx-auto" role="alert"
                                        id="contact41" style="display: none">
                                        Subject is required.
                                    </div>
                                    <div class="alert alert-dark bg-danger text-white mx-auto" role="alert"
                                        id="contact51" style="display: none">
                                        Message is required.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-1">
                                    <!-- name -->
                                    <span class="form-group">
                                        <input id="con-name" name="name1" type="text" class="form-control allMail"
                                            placeholder="Name">
                                    </span>
                                </div>
                                <div class="col-md-6 mb-1">
                                    <!-- email -->
                                    <span class="form-group">
                                        <input id="con-email" name="email1" type="email" class="form-control allMail"
                                            placeholder="Email">
                                    </span>
                                </div>
                                <div class="col-md-12 mb-1">
                                    <!-- Subject -->
                                    <span class="form-group">
                                        <input id="con-subject" name="subject1" type="text" class="form-control allMail"
                                            placeholder="Subject">
                                    </span>
                                </div>
                                <div class="col-md-12 mb-1">
                                    <!-- Message -->
                                    <span class="form-group">
                                        <textarea id="con-message" name="message1" cols="40" rows="6"
                                            class="form-control allMail" placeholder="Message"></textarea>
                                    </span>
                                </div>
                                <!-- submit button -->
                                <div class="col-md-12 text-center"><button class="btn btn-dark btn-block btn-mailus"
                                        disabled>Send Message</button></div>
                            </div>
                            <!-- End main form -->
                        </form>
        ...
        <div class="footer-copyright py-3">
            <div class="container">
                <div class="d-md-flex justify-content-between align-items-center py-3 text-center text-md-left">
                    <!-- copyright text -->
                    <div class="copyright-text text-white">Copyright © 2019 - 2021 by <a href="home" style="color: #d4d4d4">
                            Hazken Digital.</a> All Rights Reserved. RC: 3067429</div>
