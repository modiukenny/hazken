...
<meta name="description" content="Hazken Digital::
								...
								<ul class="dropdown-menu" aria-labelledby="blogMenu">
									...
									<li class="dropdown-submenu">
										...
										<ul class="dropdown-menu">
											...
											<li> <a class="dropdown-item" href="flyers">Flyers and Handbills</a> </li>
											<li> <a class="dropdown-item" href="letterhead_&_envelopes">LetterHead and Branded Envelopes</a> </li>
											<li> <a class="dropdown-item" href="t-shirts">T-shirts Printing</a> </li>
											<li> <a class="dropdown-item" href="id_cards">Plastic Identity Cards</a> </li>
										</ul>
									</li>
									<li class="dropdown-submenu">
        ...
        <div class="container bg-light">
                ...
                style="background: #DCDDDF; border-radius: 25px">
                  ...
                  <div class="media-body mt-4 align-self-center">
                    ...
                    <p style="font-size: 15px" class="text-dark"><span class="font-weight-bolder" title="Hazken Digital Chief Executive Officer CEO, Lead Consultant and Founder">
					...
					<div class="col-md-3 col-sm-6">
						<div class="widget address text-all-white">
							<ul class="list-unstyled">
								...
								<li class="media mb-3"><i class="mr-3 display-8 ti-headphone-alt"></i> <a class="mr-1" href="tel:+2348176246387">+234 817 6246 387,</a> <a href="tel:+2349029480399">+234 902 9480 399</a> </li>
								<li class="media mb-3"><i class="mr-3 display-8 ti-email"></i><a href="mailto:hazkendigital@gmail.com" class="text-all-white">hazkendigital@gmail.com</a></li>
		...
		<div class="footer-copyright py-3">
			<div class="container">
				<div class="d-md-flex justify-content-between align-items-center py-3 text-center text-md-left">
					<!-- copyright text -->
					<div class="copyright-text text-white">All Rights Reserved ©2020 by <a href="home" style="color: #d4d4d4"> Hazken Digital</a></div>
					<!-- copyright links-->
