	...
	<div class="container">
			...
			style="border-bottom: 4px solid #7E2726;">
					...
					<div class="collapse navbar-collapse" id="collapsibleNavbar">
						...
						<li class="nav-item">
								<a class="nav-link text-danger" title="WELCOME TO HAZKEN GRAPHICS" href="home"
					...
					<div class="col-md-3 col-sm-6">
						<div class="widget address text-all-white">
							<ul class="list-unstyled">
								...
								<li class="media mb-3"><i class="mr-3 display-8 ti-email"></i><a href="mailto:hazkengraphics@gmail.com" class="text-all-white">hazkengraphics<br>@gmail.com</a></li>
					...
					<div class="col-md-3">
						<div class="widget bg-light p-4 border-radius-3">
							...
							<div class="form-group mb-0">
								...
								<button class="btn btn-dark mb-0 text-white"><a href="mailto:hazkengraphics@gmail.com" style="text-decoration: none; color:white">Join us</a></button>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="footer-copyright py-3">
			<div class="container">
				<div class="d-md-flex justify-content-between align-items-center py-3 text-center text-md-left">
					<!-- copyright text -->
					<div class="copyright-text text-white">All Rights Reserved ©2020 by <a href="home" style="color: #d4d4d4"> Hazken Graphics</a></div>
					<!-- copyright links-->
